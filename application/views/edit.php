			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						...
						<option value="Kewirausahaan" <?php if($data['Program_Studi'] == 'Kewirausahaan'){ echo 'selected'; } ?>>Kewirausahaan</option>
						<option value="Ekonomi" <?php if($data['Program_Studi'] == 'Ekonomi'){ echo 'selected'; } ?>>Ekonomi</option>
						<option value="Ilmu Pemerintahan" <?php if($data['Program_Studi'] == 'Ilmu Pemerintahan'){ echo 'selected'; } ?>>Ilmu Pemerintahan</option>
						<option value="Hubungan Internasional" <?php if($data['Program_Studi'] == 'Hubungan Internasional'){ echo 'selected'; } ?>>Hubungan Internasional</option>
					</select>
				</div>
			</div>
			<div class="item form-group">
