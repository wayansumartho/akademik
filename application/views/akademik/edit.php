...
<div class="container" style="margin-top:20px">
	...
	if (isset($_POST['submit'])) {
		...
		if ($sql) {
			echo '<script>alert("Berhasil menyimpan data."); document.location="tampil_mhs";</script>';
		} else {
	...
	<form action="<?php base_url("index.php/akademik/edit_tampil?page=edit_mhs&Nim=" . $data['Nim']) ?> " method="post">
		...
		<div class="item form-group">
			...
			<div class="col-md-6 col-sm-6">
				<select name="Program_Studi" class="form-control" required>
					...
					<option value="Teknik Komputer" <?php if ($data['Program_Studi'] == 'Teknik Komputer') {
														echo 'selected';
					...
					<option value="Kewirausahaan" <?php if ($data['Program_Studi'] == 'Kewirausahaan') {
														echo 'selected';
													} ?>>Kewirausahaan</option>
					<option value="Ekonomi" <?php if ($data['Program_Studi'] == 'Ekonomi') {
												echo 'selected';
											} ?>>Ekonomi</option>
					<option value="Ilmu Pemerintahan" <?php if ($data['Program_Studi'] == 'Ilmu Pemerintahan') {
															echo 'selected';
														} ?>>Ilmu Pemerintahan</option>
					<option value="Hubungan Internasional" <?php if ($data['Program_Studi'] == 'Hubungan Internasional') {
																echo 'selected';
		...
		<div class="item form-group">
			<div class="col-md-6 col-sm-6 offset-md-3">
				...
				<a href="<?= base_url('index.php/akademik/tampil_mhs'); ?>" class=" btn btn-warning">Kembali</a>
			</div>
		</div>
	</form>
</div>